...
static inline int generate_main_c(const char *project_dir) {
    ...
    fprintf(f, " * @brief Main entry point for transpiled GameCube code\n");
    ...
    fprintf(f, "/**\n");
    fprintf(f, " * @brief Main entry point\n");
    fprintf(f, " * \n");
    fprintf(f, " * This test harness initializes the PowerPC emulation environment.\n");
    fprintf(f, " * Modify this function to call specific transpiled functions for testing.\n");
    fprintf(f, " */\n");
    ...
    fprintf(f, "    // TODO: Call your transpiled functions here\n");
    fprintf(f, "    // Example:\n");
